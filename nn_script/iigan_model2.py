...
class Model(ModelAbs):
    ...
    def conv2_wapper(self, input_tensor, output_dim, wd, layer_name, \
        ...
        if add_batch_norm: 
            conv = mf.batch_norm_layer(conv, train_test_ph) 
    ...
    def discriminator_pair(self, g_image, data_ph, wd, leaky_param):
        df_dim = 64 # first dimention of the first layer
        with tf.variable_scope("D_pair"):
    ...
    def discriminator_real(self, g_image, data_ph, wd, leaky_param):
        df_dim = 64 # first dimention of the first layer
    ...
    def model_infer(self, data_ph, model_params):
        ...
        fc_real = self.discriminator_real(g_image, data_ph, wd, leaky_param)

        self.fc_pair = fc_pair
    ...
    def get_loss(self):
        return self.d_w_loss, self.g_w_loss
